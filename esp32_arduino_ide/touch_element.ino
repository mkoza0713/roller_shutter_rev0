String touch_function() {
  ...
  //kafelki obszarów
  else if (x >= button_3[0] && x <= button_3[2] + button_3[0] && y >= button_3[1] && y <= button_3[3] + button_3[1]) {
    // Serial.println("button 2");
    tft.fillRoundRect(button_3[0], button_3[1], button_3[2], button_3[3], button_3[4], button_insert_colour);
    return "button_3";  //id przycisku to moglo by wracac z f()
  } 
    ...
    return "button_4";  //id przycisku to moglo by wracac z f()
  }
    ...
    return "button_5";  //id przycisku to moglo by wracac z f()
  }
    ...
    return "button_6";  //id przycisku to moglo by wracac z f()
  }
